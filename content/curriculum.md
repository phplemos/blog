...
* **Key Responsibilities:**
    ...
    - Followed accessibility best practices adhering to WCAG guidelines.
...
* **Technologies:** Laravel (PHP), React.js, React Native, Blade, PostgreSQL, Docker, Gitflow.
* **Key Responsibilities:**
    - **Fullstack Development:** Built new features and RESTful APIs using Laravel and React.js/Blade. Assisted in React Native mobile development for parallel projects.
    - **Infrastructure & DevOps:** Provisioned and managed containers for development and production environments using Docker, and configured custom Docker networks.
    - **Software Maintenance:** Resolved critical failures, refactored codebase, and analyzed compatibility when migrating system legacy versions from PHP 7.4 to 8.2. Mapped application flows to document and fix inconsistencies.
    - **Database:** Managed PostgreSQL database operations and optimized queries.
    - **Process Improvement:** Implemented automated tests, refined Gitflow workflows, promoted coding standards (PSRs), and created onboarding documentation for new developers.
...
1. **UniEspaços - Academic Space Management Platform** *(2025)*
   ...
   * **Description:** A space management platform designed to solve the challenges of managing UESB's institutional spaces. Code available on [GitHub](https://github.com/uniespacos/app).
1. **ReserveLMP: Platform for Managing Reservations and Use of Multi-User Resources** *(2025)*

   * **Registry Institution:** INPI (*Instituto Nacional da Propriedade Industrial*)
   * **Registration Number:** BR512025005138-7 (Filed/Granted: 21/10/2025)
   * **Funding Institution:** UESB
   * **Description:** A multi-user resource and reservation management system for the Pro-Rectory of Research and Innovation at UESB.
...
* **English:** Functional (Reading, Writing, Speaking, and Understanding)